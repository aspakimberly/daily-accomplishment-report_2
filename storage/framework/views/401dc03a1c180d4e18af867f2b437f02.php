...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/homepage.css')); ?>?v=<?php echo e(filemtime(public_path('css/homepage.css'))); ?>">
...
<body>
    <div class="page-shell">
        ...
        <main class="home-card">
            <?php echo $__env->make('components.topbar', ['active' => 'home', 'canAccessAudit' => $canAccessAudit, 'user' => $user], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <section class="hero-section">
                <div class="hero-copy">
                    ...
                    <div>
                        ...
                        <a href="<?php echo e(route('dashboard')); ?>" class="cta-button">Get started</a>
                    </div>
                </div>
                ...
                <div class="hero-visual">
                    ...
                    <div class="photo-frame">
                        <img src="<?php echo e(asset('images/dictpang.jpg')); ?>" alt="DICT Office" loading="lazy">
                    </div>
...
<?php /**PATH C:\xampp_new\htdocs\daily_accomplishment_report\resources\views/auth/homepage.blade.php ENDPATH**/ ?>